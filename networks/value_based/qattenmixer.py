...
class QattenMixer(nn.Module):
    def __init__(self, n_agents, state_shape, unit_dim, mixing_embed_dim=64,n_actions=6):
        ...
        self.n_head = 4  # attention head num

        self.embed_dim = mixing_embed_dim
        self.hypernet_layers = 2
        self.hypernet_embed=64
        self.attend_reg_coef = 0.01
        self.nonlinear=False
        self.weighted_head=False
        self.mask_dead: False
        self.state_bias=True
